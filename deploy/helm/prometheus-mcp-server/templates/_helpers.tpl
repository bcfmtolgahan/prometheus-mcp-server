...
app.kubernetes.io/part-of: sre-agent
{{- end }}
...
*/}}
{{- define "prometheus-mcp-server.authSecretName" -}}
{{- if .Values.auth.existingSecret }}
{{- .Values.auth.existingSecret }}
{{- else }}
{{- include "prometheus-mcp-server.fullname" . }}-auth
{{- end }}
{{- end }}
...
*/}}
{{- define "prometheus-mcp-server.tlsSecretName" -}}
{{- if .Values.tls.existingSecret }}
{{- .Values.tls.existingSecret }}
{{- else }}
{{- include "prometheus-mcp-server.fullname" . }}-tls
{{- end }}
{{- end }}
